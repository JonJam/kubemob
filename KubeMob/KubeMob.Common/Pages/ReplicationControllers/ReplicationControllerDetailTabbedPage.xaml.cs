...
{
    public partial class ReplicationControllerDetailTabbedPage : TabbedPage
    {
        [Preserve]
        public ReplicationControllerDetailTabbedPage() => this.InitializeComponent();
        ...
        protected override async void OnCurrentPageChanged()
        {
            ...
            ReplicationControllerDetailViewModel detailViewModel = (ReplicationControllerDetailViewModel)this.DetailPage.BindingContext;
