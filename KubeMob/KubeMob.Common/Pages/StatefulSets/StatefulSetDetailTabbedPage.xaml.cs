...
{
    public partial class StatefulSetDetailTabbedPage : TabbedPage
    {
        [Preserve]
        public StatefulSetDetailTabbedPage() => this.InitializeComponent();
        ...
        protected override async void OnCurrentPageChanged()
        {
            ...
            StatefulSetDetailViewModel detailViewModel = (StatefulSetDetailViewModel)this.DetailPage.BindingContext;
