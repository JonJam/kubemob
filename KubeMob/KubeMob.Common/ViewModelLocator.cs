...
using KubeMob.Common.ViewModels.Roles;
...
namespace KubeMob.Common
{
    ...
    public static class ViewModelLocator
    {
            ...
            IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddTransient<DeploymentDetailTabbedViewModel>();
            ...
            serviceCollection.AddTransient<StatefulSetDetailTabbedViewModel>();
            ...
            serviceCollection.AddTransient<PersistentVolumeDetailTabbedViewModel>();
        ...
        private static void ConfigureMaps() =>
            ...
            Mapper.Initialize(cfg =>
            {
                ...
                cfg.AddProfile<EndpointsMappingProfile>();
            });
