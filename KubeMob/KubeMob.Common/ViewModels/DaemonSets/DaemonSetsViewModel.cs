...
namespace KubeMob.Common.ViewModels.DaemonSets
{
    ...
    public class DaemonSetsViewModel : ObjectListViewModelBase
    {
        ...
        protected override Task OnObjectSummarySelectedExecute(object obj)
        {
            ...
            return this.NavigationService.NavigateToDaemonSetDetailPage(selected.Name, selected.NamespaceName);
        }
    }
}
