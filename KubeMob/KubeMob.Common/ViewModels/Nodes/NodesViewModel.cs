...
namespace KubeMob.Common.ViewModels.Nodes
{
    ...
    public class NodesViewModel : ObjectListViewModelBase
    {
        ...
        protected override Task<IList<ObjectSummary>> GetObjectSummaries(string filter) => this.KubernetesService.GetNodeSummaries();
