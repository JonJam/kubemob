...
namespace KubeMob.Common.ViewModels.PersistentVolumeClaims
{
    ...
    public class PersistentVolumeClaimDetailViewModel : ViewModelBase
    {
        private readonly IKubernetesService kubernetesService;
        private readonly IPopupService popupService;

        private string name;
        private PersistentVolumeClaimDetail detail;
        ...
        public PersistentVolumeClaimDetail Detail
        {
            get => this.detail;
        ...
        public override async Task Initialize(object navigationData)
        {
            ...
            await this.PerformNetworkOperation(async () =>
            {
                try
                {
                    this.Detail = await this.kubernetesService.GetPersistentVolumeClaimDetail(objectId.Name, objectId.NamespaceName);
                }
