...
namespace KubeMob.Common.ViewModels.ReplicaSets
{
    ...
    public class ReplicaSetDetailViewModel : ViewModelBase
    {
        private readonly IKubernetesService kubernetesService;
        private readonly IPopupService popupService;

        private string name;
        private ReplicaSetDetail detail;
        ...
        public ReplicaSetDetail Detail
        {
            get => this.detail;
        ...
        public override async Task Initialize(object navigationData)
        {
            ...
            await this.PerformNetworkOperation(async () =>
            {
                try
                {
                    this.Detail = await this.kubernetesService.GetReplicaSetDetail(objectId.Name, objectId.NamespaceName);
                }
