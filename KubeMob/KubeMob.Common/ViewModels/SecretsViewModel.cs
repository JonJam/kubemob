...
namespace KubeMob.Common.ViewModels
{
    ...
    public class SecretsViewModel : ViewModelBase
    {
        ...
        public IList<SecretSummary> Secrets
        {
            ...
            private set
            {
                if (this.SetProperty(ref this.secrets, value))
                {
                    this.NotifyPropertyChanged(() => this.HasSecrets);
                }
            }
        }
        ...
        public bool HasSecrets => this.Secrets.Count > 0;
        ...
        public override async Task Initialize(object navigationData)
        {
            ...
            try
            {
                this.Secrets = await this.kubernetesService.GetSecretSummaries();
            }
