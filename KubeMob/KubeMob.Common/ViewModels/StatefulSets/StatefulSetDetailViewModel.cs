...
namespace KubeMob.Common.ViewModels.StatefulSets
{
    ...
    public class StatefulSetDetailViewModel : ViewModelBase
    {
        private readonly IKubernetesService kubernetesService;
        private readonly IPopupService popupService;

        private string name;
        private StatefulSetDetail detail;
        ...
        public StatefulSetDetail Detail
        {
            get => this.detail;
        ...
        public override async Task Initialize(object navigationData)
        {
            ...
            await this.PerformNetworkOperation(async () =>
            {
                try
                {
                    this.Detail = await this.kubernetesService.GetStatefulSetDetail(objectId.Name, objectId.NamespaceName);
                }
